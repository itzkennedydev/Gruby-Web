              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    {!status.onboardingStatus.isComplete && (
                      <Button 
                  ...
                  {status.onboardingStatus.isComplete && (
                    <Alert className="border-green-200 bg-green-50">
                      ...
                      <AlertDescription className="text-green-800">
                        Congratulations! Your account setup is complete. You can now start accepting payments.
                      </AlertDescription>
                    </Alert>
                  )}
                </>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">Unable to load onboarding status</p>
                </div>
              )}
            </CardContent>
          </Card>
