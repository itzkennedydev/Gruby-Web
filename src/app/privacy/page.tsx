      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
        <div className="prose prose-lg max-w-none" style={{
          ...
          <section className="mb-10 sm:mb-8">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-8 sm:mt-6 mb-4 sm:mb-3" style={{ lineHeight: '1.4' }}>4.3 User Content</h3>
            <p className="mb-6 sm:mb-4" style={{ lineHeight: '1.75' }}>
          ...
          <section className="mb-10 sm:mb-8">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-8 sm:mt-6 mb-4 sm:mb-3" style={{ lineHeight: '1.4' }}>7.3 Virginia, Colorado, Connecticut, and Utah Privacy Rights</h3>
            <p className="mb-6 sm:mb-4" style={{ lineHeight: '1.75' }}>
