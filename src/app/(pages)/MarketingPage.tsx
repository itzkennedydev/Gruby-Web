              ...
              <div className="col-span-1 sm:col-span-2 md:col-span-1">
                ...
                <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-[13px] bg-[#504944] px-4 py-2.5 text-white no-underline shadow-sm transition-all duration-200 hover:bg-[#403a36] active:scale-[0.98]"
                  >
                    <svg
                      className="h-5 w-5"
                      viewBox="0 0 24 24"
