    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="prose prose-lg max-w-none">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-4">GRUBY TERMS OF SERVICE</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">1. ACCEPTANCE OF TERMS</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">2. ELIGIBILITY</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">3. ACCOUNT REGISTRATION AND SECURITY</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">4. USER-GENERATED CONTENT</h2>
            
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">4.1 License Grant</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">4.2 Representations and Warranties</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">4.3 Content Standards</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">4.4 DMCA Compliance</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">4.5 Content Removal</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">5. INTELLECTUAL PROPERTY RIGHTS</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">6. THIRD-PARTY SERVICES AND INTEGRATIONS</h2>
            
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">6.1 Third-Party Platforms</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">6.2 Disclaimer of Third-Party Liability</h3>
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">6.3 Kroger Integration</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">7. DISCLAIMER OF WARRANTIES</h2>
            <p className="mb-4 font-semibold">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">8. LIMITATION OF LIABILITY</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">9. INDEMNIFICATION</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">10. BINDING ARBITRATION AND CLASS ACTION WAIVER</h2>
            
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">10.1 Agreement to Arbitrate</h3>
            <p className="mb-4 font-semibold">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">10.2 Exceptions</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">10.3 Class Action Waiver</h3>
            <p className="mb-4 font-semibold">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">10.4 Opt-Out</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">10.5 Arbitration Procedures</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">11. GOVERNING LAW AND VENUE</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">12. TERMINATION</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">13. APPLE APP STORE ADDITIONAL TERMS</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">14. GENERAL PROVISIONS</h2>
            
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">14.1 Entire Agreement</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">14.2 Severability</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">14.3 Waiver</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">14.4 Assignment</h3>
            <p className="mb-4">
              You may not assign or transfer these Terms or your rights hereunder without our prior written consent. We may assign these Terms without restriction.
            </p>

            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">14.5 Force Majeure</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold mt-6 mb-3">14.6 Notices</h3>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4">15. CONTACT INFORMATION</h2>
            <p className="mb-4">
